<?php require_once $_SERVER['DOCUMENT_ROOT'].'/www/preset.php' ?>

<?php
$file_name = $_FILES['upload_file']['name'];
$tmp_file = $_FILES['upload_file']['tmp_name'];

$file_path = $_SERVER['DOCUMENT_ROOT'].'/www/files/'.$file_name;
$image_url = $_SERVER['DOCUMENT_ROOT'].'/www/files/'.$file_name;
